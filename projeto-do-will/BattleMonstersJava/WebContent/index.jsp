  ...
  <div class="container" id="content">
    <div id="holder" class="row">
      ...
      <div class="col-xs-offset-4 col-xs-4 home-login">
        ...
        <form method="post" action="/prjBattleMonstersWeb/Login">
          ...
          <button type="submit" class="btn btn-default col-xs-12 mb-30" >Entrar</button>
          <a href="cadastro.jsp" type="button" class="btn btn-default col-xs-12">Novo no jogo? Cadastre-se!</a>
        </form>
      </div>
    </div>
